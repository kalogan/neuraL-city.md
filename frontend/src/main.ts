...
canvasHost.className = 'absolute inset-0';
app.appendChild(canvasHost);

const hud = document.createElement('div');
hud.className = 'absolute bottom-0 left-0 right-0 p-3 flex gap-3 transition-all duration-300';
app.appendChild(hud);

const message = document.createElement('div');
message.className = 'absolute top-16 right-3 bg-red-500/90 px-3 py-2 rounded hidden';
