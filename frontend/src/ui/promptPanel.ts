...
export function createPromptPanel(onData: () => void): HTMLElement {
  ...
  panel.className = 'absolute top-0 left-0 right-0 z-30 p-3 bg-slate-950/70 backdrop-blur-md border-b border-cyan-500/20 flex gap-2 transition-all duration-300';
  panel.innerHTML = `
